...
namespace Lab7
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nList of all workers with first 'A' in the surname: ");
            ...
            Console.WriteLine("\nInformation of all departments and about number of workers in each one: ");
            ...
            Console.WriteLine("\nA list of departments in which all workers surnames start with an 'A': ");
            ...
            Console.WriteLine("\n\nList of departments in which at least one worker " +
                 "has a surname beginning with 'A': ");
            ...
            Console.WriteLine("\n\nList of all departments and number of worker in each department: ");
